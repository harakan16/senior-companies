...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-brand-600 hover:bg-brand-800 text-white shadow-lg shadow-brand-500/30 focus:ring-brand-500",
    secondary: "bg-gold-500 hover:bg-gold-600 text-white shadow-lg shadow-gold-500/30 focus:ring-gold-500",
